...
export function generateDeepLinkingURL() {
    ...
    const appScheme = interfaceConfig.APP_SCHEME || 'xn--90abj.xn--e1aajfpcds8ay4h.xn--80asehdb';
    ...
    if (Platform.OS === 'android') {
        ...
        const pkg = interfaceConfig.ANDROID_APP_PACKAGE || 'xn--90abj.xn--e1aajfpcds8ay4h.xn--80asehdb';
